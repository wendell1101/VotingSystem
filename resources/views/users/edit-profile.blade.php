        ...
        <form action="{{ route('users.update-profile', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col text-center">
                    <img id="uploadPreview" src="{{ asset('storage/profile_images/'. $user->image) }}" class="img-fluid border rounded-circle" style="width: 100px; height:100px; border:none!important" /><br>
                    <label for="image">
                        <h2>

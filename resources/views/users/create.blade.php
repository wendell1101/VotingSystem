        ...
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col text-center">
                    <img id="uploadPreview" src="https://mykskhomes.com/assets/css/grocery/images/default.png" class="img-fluid border" style="width: 130px; height:120px; border:none!important" /><br>
                    <label for="image">
                        <h2>
